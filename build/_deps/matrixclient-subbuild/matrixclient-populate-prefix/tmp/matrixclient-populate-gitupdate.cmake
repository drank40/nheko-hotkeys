...
execute_process(
  COMMAND "/usr/bin/git" show-ref "a3fec0ae53762a8a482cde50c9709671bcf0548d"
  WORKING_DIRECTORY "/home/renny/doc/c++/nheko/build/_deps/matrixclient-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "a3fec0ae53762a8a482cde50c9709671bcf0548d")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("a3fec0ae53762a8a482cde50c9709671bcf0548d" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/a3fec0ae53762a8a482cde50c9709671bcf0548d")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/renny/doc/c++/nheko/build/_deps/matrixclient-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/renny/doc/c++/nheko/build/_deps/matrixclient-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
